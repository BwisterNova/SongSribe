          ...
          <ScrollArea className="h-[calc(100vh-180px)]">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {lyricsHistory.map((item) => (
                <Card
                  key={item.id}
                  className="bg-card/50 backdrop-blur-sm border border-purple-500/20 rounded-2xl overflow-hidden hover:border-purple-500/40 transition-all group cursor-pointer"
                >
                  ...
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-purple-300 truncate">{item.artist}</p>
