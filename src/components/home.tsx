    ...
    <div className="min-h-screen w-full bg-background">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-30 bg-background/80 backdrop-blur-md border-b border-purple-500/20 px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="sm" className="text-foreground hover:text-purple-400 flex items-center gap-2">
        ...
        <footer className="py-12 lg:py-16 px-4 border-t border-purple-500/20 bg-gradient-to-b from-transparent to-purple-900/5">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
              ...
              {/* Resources */}
              <div>
                <h3 className="text-lg font-bold mb-4 text-purple-400">Resources</h3>
                <ul className="space-y-2">
                  <li>
                    <Button variant="link" className="text-muted-foreground hover:text-purple-400 p-0 h-auto">
                      Step-by-Step Guide
                    </Button>
                  </li>
                </ul>
              ...
              {/* Get In Touch */}
              <div>
                <h3 className="text-lg font-bold mb-4 text-purple-400">Get In Touch</h3>
